...
if(DEFINED ENV{RISCV})
    file(TO_CMAKE_PATH $ENV{RISCV} RISCV)
else()
    message(FATAL_ERROR "RISCV env must be defined")
endif()

set(RISCV ${RISCV} CACHE STRING "root path to riscv toolchain")

set(CMAKE_C_COMPILER "${RISCV}/bin/riscv64-unknown-linux-gnu-gcc")
set(CMAKE_CXX_COMPILER "${RISCV}/bin/riscv64-unknown-linux-gnu-g++")

set(CMAKE_FIND_ROOT_PATH "${RISCV}/riscv64-unknown-linux-gnu")
